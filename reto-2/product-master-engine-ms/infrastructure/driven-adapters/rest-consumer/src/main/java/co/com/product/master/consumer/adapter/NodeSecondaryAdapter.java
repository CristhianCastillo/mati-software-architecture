...
public class NodeSecondaryAdapter implements SecondaryReserveGateway {
    ...
    public Mono<ReserveResult> reserveProduct(Reserve reserve) {
        return this.clientWebClient
                ...
                .doOnSubscribe(subscription -> log.info("SECONDARY :: Product Reserve Request",
    ...
    private Mono<ProductException> mapErrorResponse(GenericResponseDto<GenericErrorResponseDto> apiErrorResponse) {
        log.error("SECONDARY :: Client Error Response", kv("clientErrorResponse", apiErrorResponse));
