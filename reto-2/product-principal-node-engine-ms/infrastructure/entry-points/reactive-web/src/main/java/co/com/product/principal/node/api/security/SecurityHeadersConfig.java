package co.com.product.principal.node.api.security;
...
public class SecurityHeadersConfig implements WebFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        ContextRegistry.getInstance()
                ...
                .registerThreadLocalAccessor(TracingConstants.PROPERTY_CONFIG_KEY, () -> MDC.get(TracingConstants.PROPERTY_CONFIG_KEY),
                        clientEmail -> MDC.put(TracingConstants.PROPERTY_CONFIG_KEY, clientEmail),
                        () -> MDC.remove(TracingConstants.PROPERTY_CONFIG_KEY));
